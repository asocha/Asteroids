...
void Asteroid::CreateVerticesBasedOnShape() const{
	...
	v0.m_position = Vec3(-2.0f, -8.0f);
	v1.m_position = Vec3(3.0f, -9.0f);
	v2.m_position = Vec3(8.0f, -2.5f);
	v3.m_position = Vec3(8.5f, 3.0f);
	v4.m_position = Vec3(3.5f, 8.0f);
	v5.m_position = Vec3(-3.0f, 8.0f);
	v6.m_position = Vec3(-7.0f, 3.0f);
	v7.m_position = Vec3(-8.0f, -3.5f);
	...
	ASTEROID_VERTICES_CROSS.push_back(v6);
	ASTEROID_VERTICES_CROSS.push_back(v7);

	v0.m_position = Vec3(-7.0f, -2.0f);
	v1.m_position = Vec3(-4.0f, -4.0f);
	v2.m_position = Vec3(0.0f, -7.0f);
	v3.m_position = Vec3(5.0f, -5.0f);
	v4.m_position = Vec3(8.0f, -1.0f);
	v5.m_position = Vec3(4.0f, 4.0f);
	v6.m_position = Vec3(-1.0f, 7.0f);
	v7.m_position = Vec3(-3.0f, 3.0f);
	ASTEROID_VERTICES_MUSHROOM.push_back(v0);
	ASTEROID_VERTICES_MUSHROOM.push_back(v1);
	ASTEROID_VERTICES_MUSHROOM.push_back(v2);
	ASTEROID_VERTICES_MUSHROOM.push_back(v3);
	ASTEROID_VERTICES_MUSHROOM.push_back(v4);
	ASTEROID_VERTICES_MUSHROOM.push_back(v5);
	ASTEROID_VERTICES_MUSHROOM.push_back(v6);
	ASTEROID_VERTICES_MUSHROOM.push_back(v7);
	v0.m_position = Vec3(-7.0f, -2.0f);
	v1.m_position = Vec3(-3.0f, -6.0f);
	v2.m_position = Vec3(1.0f, -5.0f);
	v3.m_position = Vec3(5.0f, -2.0f);
	v4.m_position = Vec3(6.0f, 2.0f);
	v5.m_position = Vec3(2.0f, 6.0f);
	v6.m_position = Vec3(-5.0f, 4.0f);
	...
	ASTEROID_VERTICES_TEXAS.push_back(v6);

	v0.m_position = Vec3(-7.0f, 3.0f);
	v1.m_position = Vec3(-7.0f, -3.0f);
	v2.m_position = Vec3(-1.0f, -7.0f);
	v3.m_position = Vec3(6.0f, -5.0f);
	v4.m_position = Vec3(7.0f, 0.0f);
	v5.m_position = Vec3(5.0f, 4.0f);
	v6.m_position = Vec3(0.0f, 7.0f);
	v7.m_position = Vec3(-3.0f, 5.0f);
	...
	ASTEROID_VERTICES_TREE.push_back(v4);
	ASTEROID_VERTICES_TREE.push_back(v5);
	ASTEROID_VERTICES_TREE.push_back(v6);
	ASTEROID_VERTICES_TREE.push_back(v7);
